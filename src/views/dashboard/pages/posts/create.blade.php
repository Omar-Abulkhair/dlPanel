...
@section('content')
    <div class="content-body">
        <!-- Basic Inputs start -->
        <form id="post-form" action="{{route('dashboard.posts.store')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                                    ...
                                    <fieldset>
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control" placeholder="Seo Excerpt"
                                                      ...
                                                      name="excerpt" required> Excerpt </textarea>
                                        </div>
                                    </fieldset>
                                </div>
                            </div>
                ...
                {{-- Submit Button --}}
                <div class="col-md-12">
                    <button type="submit" class="btn btn-success col-12 py-2">Save Post</button>
                </div>
            </div>
        </form>
        <!-- Basic Inputs end -->
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#post-form').submit(function (e) {
                e.preventDefault();
                let form = new FormData($("#post-form")[0])
                ...
                $.ajax({
                    ...
                    if (r.status == true) {
                        toastr.success('Post Added Successfully.', 'Status');
                    } else {
